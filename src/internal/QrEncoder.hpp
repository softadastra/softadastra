 ...
 *  Softadastra
 *
 *  @brief Provides an internal QR Code encoder.
 *
 *  Implements QR Code generation compliant with ISO/IEC 18004:2015.
 *  Supports Numeric, Alphanumeric, and Byte encoding modes, versions 1
 *  through 40 with automatic version selection, error correction levels
 *  L, M, Q, and H, Reed-Solomon error correction, all eight mask patterns,
 *  penalty scoring, and terminal ASCII rendering.
 */
